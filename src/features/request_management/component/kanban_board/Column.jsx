...
export default function Column({
  ...
  return (
    <div className="flex flex-col bg-gray-100 rounded-md  w-full min-w-[250px] h-[78vh] max-h-[80vh] overflow-y-scroll  custom-scrollbar">
      <div className="font-semibold text-xs p-4  bg-gray-100 sticky top-0">
        {title.toUpperCase()}
        <button onClick={() => removeColumn(columnID)} className="float-right">
          <X size={18} />
        </button>
      </div>
      ...
      <Droppable droppableId={id}>
        {(provided, snapshot) => (
          <div
            ...
            className="flex-grow min-h-[100px] rounded-sm"
          >
