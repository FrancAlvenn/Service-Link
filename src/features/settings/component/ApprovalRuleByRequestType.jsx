...
import { FunnelSimple, PencilSimple, Plus, Trash } from "@phosphor-icons/react";
          ...
          <div className="flex flex-col gap-6 mb-6">
            <div>
              ...
              <div className="mt-3 p-3 bg-gray-50 border border-gray-200 rounded-md flex flex-wrap items-center gap-3">
                ...
                <RequestTypeSelect value={editValues.request_type} onChange={handleChange} />
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                color="green"
                onClick={async () => {
                  if (editValues.request_type === "" || editValues.position_id === "") return;
                ...
                disabled={editValues.request_type === "" || editValues.position_id === ""}
                >
        ...
        <DialogFooter className="flex gap-2">
          ...
          <Button
            ...
            onClick={async () => {
              ...
              setUpdateError("");
              try {
                await updateApprovalRuleByRequestType(editIndex, editValues);
              } catch (e) {
            ...
            disabled={editValues.request_type === "" || editValues.position_id === "" || savingUpdate}
          >
...
ApprovalRuleByRequestType.propTypes = {};
