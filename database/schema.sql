...
(reference_number, date_filled, date_of_trip, time_of_departure, time_of_arrival, number_of_passengers, destination, purpose, requestor, designation, status, vehicle_id, remarks, immediate_head_approval, gso_director_approval, operations_director_approval) 
VALUES
...
CREATE TABLE requests_comments (
    ...
    FOREIGN KEY (request_id) REFERENCES job_request(request_id),
