...
const EmployeeSidebar = ({ open, onClose, referenceNumber, employees, fetchEmployees }) => {
      ...
      >
        {employee ? (
          <div className="flex flex-col overflow-y-auto h-full">
            ...
            <Button color="red" onClick={handleDelete} className="w-full min-h-[40px] max-w-[160px] mt-3">
              Delete Employee
            </Button>
          </div>
        ) : (
