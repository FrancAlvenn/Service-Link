    ...
    <div className=" bg-white dark:bg-gray-900 rounded-lg w-full mt-0 px-3 pt-4 pb-20 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3 pt-5 pb-2 px-5 border border-gray-200 dark:border-gray-700 rounded-lg w-full">
        ...
        {[
          {
            key: "account",
            icon: <Gear size={20} className="text-black dark:text-gray-200" />,
            label: "Account Settings",
          },
          {
            key: "notification",
            icon: <Bell size={20} className="text-black dark:text-gray-200" />,
            label: "Notification Settings",
          },
          {
            key: "theme",
            icon: <Sun size={20} className="text-black dark:text-gray-200" />,
            label: "Theme",
          },
          {
            key: "privacy",
            icon: <Lock size={20} className="text-black dark:text-gray-200" />,
            label: "Privacy Policy",
          },
          {
            key: "terms",
            icon: (
              <FileText size={20} className="text-black dark:text-gray-200" />
            ),
      ...
      {/* <div className="flex flex-col p-5 border border-gray-200 dark:border-gray-700 rounded-lg w-full">
        ...
        <div className="flex gap-2 py-5 items-start">
          {[
            ...
            {
              icon: (
                <Sparkle size={25} className="text-white dark:text-gray-200" />
              ),
              label: "Rate the App",
            },
            {
            ...
            >
              ...
              <Typography className="text-xs font-medium text-wrap w-full text-center text-gray-800 dark:text-gray-300">
                {label}
              </Typography>
            </div>
          ))}
