...
const Reports = () => {
    ...
    const vehicleCounts = countByField("vehicle");
    const venueCounts = countByField("venue");
    const archiveCounts = {
  ...
  return (
    <div className="w-full p-6 bg-white dark:bg-gray-900 mt-0 px-3 flex flex-col justify-between transition-colors">
      <div className="flex flex-col gap-1 mb-4">
        <Typography color="black" className="text-lg font-bold">Reports</Typography>
        <Typography color="gray" className="font-normal text-sm">See information about requests</Typography>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-md p-4 h-fit">
          <h2 className="text-lg font-medium mb-2">Request Status Distribution</h2>
          <Doughnut data={{
        ...
        <div className="bg-white rounded-2xl shadow-md p-4 col-span-1 sm:col-span-2 h-fit">
          <h2 className="text-lg font-medium mb-2">Approval Trends Over Time</h2>
          <Line data={{
        ...
        {/* 10. User Count */}
        <div className="bg-white rounded-2xl shadow-md p-4 h-fit">
          <h2 className="text-lg font-medium mb-2">Access Control Distribution</h2>
          <Pie data={{
