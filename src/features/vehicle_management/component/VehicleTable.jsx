...
import { VehicleContext } from "../context/VehicleContext.js";
...
const VehicleTable = () => {
  ...
  const filteredRows = (Array.isArray(vehicles) ? vehicles : []).filter((row) => {
  ...
  const columns = getColumnConfig({ setVehicleModalOpen, setSelectedVehicle });
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      >
        <Header
          ...
          description={"View and manage vehicle schedules"}
        />
